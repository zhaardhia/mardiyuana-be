...
const score_course = require("../models/score_course");
const score_course_student = require("../models/score_course_student");
...
module.exports = {
  ...
  score_course: score_course(db, DataTypes),
  score_course_student: score_course_student(db, DataTypes),
  db,
};
